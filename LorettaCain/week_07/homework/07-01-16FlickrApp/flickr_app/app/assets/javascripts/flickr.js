...
// SEE STEP 4 FOR THIS FUNCTION
    ...
    images += '<div class=photo><a href="https://www.flickr.com/photos/'+photo.owner+'/'+photo.id+'"><img src="'+photoURL+'"class="image"></a></div>';
...
// This is updatePage function is the way to update the page once you scroll to the bottom.

// WE need to search for page two of our search results
//  searchFlickr( $query ); searches for page 1
//  make a new function? searchFlickrNextPage?
...
var throttled = _.throttle(function(){
  ...
  console.log("currentPage: " + currentPage + ", totalPages: " + totalPages + ", searchTerm: " + $query)
